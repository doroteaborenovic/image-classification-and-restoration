# ==============================================================================
# ABLACIJA 6: BEZ DILATED CONTEXT BLOKA (w/o Bottleneck Dilated Context)
...
# ==============================================================================
# ARHITEKTURA MODELA (BEZ DILATED CONTEXT BLOKA)
# ==============================================================================
...
# GLAVNI MODEL ZA ABLACIJU 6: BEZ DILATED CONTEXT BLOKA
class Restauracija_NoDilatedContext(nn.Module):
    def __init__(self, in_channels: int = 3, out_channels: int = 3, base_ch: int = 32):
        ...
        # NEMA DilatedContextBlock-a u bottleneck_refine
...
CKPT_SEPIA = os.path.join(DIR_ABLACIJA_CKPT, "ablation_no_dilatedcontext_sepia25ep.pth")
...
CKPT_FINAL = os.path.join(DIR_ABLACIJA_CKPT, "ablation_no_dilatedcontext_final.pth")
...
print(f"\n[INFO] Evaluacija modela (w/o Bottleneck Dilated Context) na validaciji...")
model_no_dil.eval()
...
csv_out = os.path.join(DRIVE_PROJECT_DIR, "rezultat_ablacija_6_no_dilatedcontext.csv")
