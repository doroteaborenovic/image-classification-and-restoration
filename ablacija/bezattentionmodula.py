# ==============================================================================
# ABLACIJA 5: BEZ DAMAGE ATTENTION MODULA (w/o Damage Attention) - FINALNO
...
# ==============================================================================
# MODEL: ABLACIJA 5 (BEZ DAMAGE ATTENTION MODULA)
# ==============================================================================
...
# DEKODER BEZ MAPE OŠTEĆENJA (Skip fuzija bez damage_map)
...
CKPT_SEPIA = os.path.join(DIR_ABLACIJA_CKPT, "ablation5_no_damageattention_sepia25ep_customloss.pth")
CKPT_FINAL = os.path.join(DIR_ABLACIJA_CKPT, "ablation5_no_damageattention_final_customloss.pth")
    ...
    for ep in range(EPOCHS_SEPIA):
        ...
        for batch_idx, (d_t, c_t, _) in enumerate(sepia_loader):
            ...
            if (batch_idx + 1) % ACCUMULATION_STEPS == 0 or (batch_idx + 1) == len(sepia_loader):
                torch.nn.utils.clip_grad_norm_(model_no_dmg.parameters(), max_norm=1.0)
                opt_pretrain.step()
                opt_pretrain.zero_grad()
...
print(f"\n[INFO] Evaluacija modela (w/o Damage Attention)...")
model_no_dmg.eval()
...
csv_out = os.path.join(DRIVE_PROJECT_DIR, "rezultat_ablacija_5_no_damageattention_customloss.csv")
