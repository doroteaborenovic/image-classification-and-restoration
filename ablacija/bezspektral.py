...
# Pronalaženje glavnih trening i validacionih foldera
...
# OVDE JE ISPRAVLJENO: c1 + c2 + c3 + c4 daju tačno 256 kanala
...
# GLAVNI ABLIRANI MODEL: SAMO SPATIAL GRANA
...
CKPT_SEPIA = os.path.join(DIR_ABLACIJA_CKPT, "ablation_no_spectral_sepia25ep.pth")
...
CKPT_FINAL = os.path.join(DIR_ABLACIJA_CKPT, "ablation_no_spectral_final.pth")
...
print(f"\n[INFO] Evaluacija modela (w/o Spectral Encoder) na validaciji...")
...
csv_out = os.path.join(DRIVE_PROJECT_DIR, "rezultat_ablacija_2_no_spectral.csv")
