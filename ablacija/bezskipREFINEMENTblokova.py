# ==============================================================================
# ABLACIJA 8: BEZ SKIP REFINEMENT BLOKOVA (w/o Skip Refine) - FINALNO
...
# ==============================================================================
# LOSS FUNKCIJE (ORIGINALNI RESTAURACIJA LOSS)
# ==============================================================================
...
# ==============================================================================
# MODEL: ABLACIJA 8 (BEZ SKIP REFINEMENT BLOKOVA)
# ==============================================================================
    ...
    for ep in range(EPOCHS_SEPIA):
        ...
        for batch_idx, (d_t, c_t, _) in enumerate(sepia_loader):
            ...
            if (batch_idx + 1) % ACCUMULATION_STEPS == 0 or (batch_idx + 1) == len(sepia_loader):
                torch.nn.utils.clip_grad_norm_(model_no_skip_refine.parameters(), max_norm=1.0)
                opt_pretrain.step()
                opt_pretrain.zero_grad()
...
print(f"\n[INFO] Evaluacija modela (w/o Skip Refinement Blocks)...")
