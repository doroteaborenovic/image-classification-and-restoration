...
# MODEL: BEZ SKIP REFINEMENT BLOKOVA
class Restauracija_NoSkipRefine(nn.Module):
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        # BEZ SKIP REFINE: Gejtovani skips idu direktno
...
CKPT_SEPIA = os.path.join(DIR_ABLACIJA_CKPT, "ablation8_no_skiprefine_sepia25ep_customloss.pth")
if os.path.exists(CKPT_SEPIA):
    ...
    print(f"\n=======================================================")
    print(f" FAZA 1: Trening bez Skip Refine ({EPOCHS_SEPIA} epoha na Sepia uz RestauracijaLoss)")
    print(f"=======================================================")
...
CKPT_FINAL = os.path.join(DIR_ABLACIJA_CKPT, "ablation8_no_skiprefine_final_customloss.pth")
...
csv_out = os.path.join(DRIVE_PROJECT_DIR, "rezultat_ablacija_8_no_skiprefine_customloss.csv")
