# ==============================================================================
# ABLACIJA 4: BEZ GATED BOTTLENECK FUSION MODULA (w/o Gated Fusion) - FINALNO
...
# ==============================================================================
# MODEL: ABLACIJA 4 (BEZ GATED BOTTLENECK FUSION-A)
# ==============================================================================
    ...
    for ep in range(EPOCHS_SEPIA):
        ...
        for batch_idx, (d_t, c_t, _) in enumerate(sepia_loader):
            ...
            if (batch_idx + 1) % ACCUMULATION_STEPS == 0 or (batch_idx + 1) == len(sepia_loader):
                torch.nn.utils.clip_grad_norm_(model_no_gated.parameters(), max_norm=1.0)
                opt_pretrain.step()
                opt_pretrain.zero_grad()
...
print(f"\n[INFO] Evaluacija modela (w/o Gated Bottleneck Fusion)...")
model_no_gated.eval()
