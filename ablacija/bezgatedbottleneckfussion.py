...
# GLAVNI MODEL ZA ABLACIJU 4: BEZ GATED BOTTLENECK FUSION-A
class Restauracija_NoGatedFusion(nn.Module):
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        # BEZ GATED FUSION-A: Linearno spajanje
...
CKPT_SEPIA = os.path.join(DIR_ABLACIJA_CKPT, "ablation4_no_gatedfusion_sepia25ep_customloss.pth")
if os.path.exists(CKPT_SEPIA):
    ...
    print(f"\n=======================================================")
    print(f" FAZA 1: Trening bez Gated Fusion ({EPOCHS_SEPIA} epoha na Sepia uz RestauracijaLoss)")
    print(f"=======================================================")
...
CKPT_FINAL = os.path.join(DIR_ABLACIJA_CKPT, "ablation4_no_gatedfusion_final_customloss.pth")
...
csv_out = os.path.join(DRIVE_PROJECT_DIR, "rezultat_ablacija_4_no_gatedfusion_customloss.csv")
