# ==============================================================================
# ABLACIJA 9: BEZ EDGE GUIDANCE GRANE (w/o Edge Guidance Branch) - FINALNO
...
# ==============================================================================
# MODEL: ABLACIJA 9 (BEZ EDGE GUIDANCE GRANE)
# ==============================================================================
...
class Restauracija_NoEdgeBranch(nn.Module):
    ...
    def forward(self, x: Tensor) -> Tensor | dict[str, Tensor]:
        ...
        out = self.contrast_color_recovery(refined, input_img)
...
print(f"\n[INFO] Evaluacija modela (w/o Edge Guidance Branch)...")
model_no_edge.eval()
