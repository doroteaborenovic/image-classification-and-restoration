...
# ==============================================================================
# ARHITEKTURA MODELA (BEZ EDGE BRANCH GRANE)
# ==============================================================================
...
class Restauracija_NoEdgeBranch(nn.Module):
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        # BEZ EDGE BRANCH: Izlaz final_refinement-a direktno ide u CCR bez fuzije sa Edge granom
...
CKPT_SEPIA = os.path.join(DIR_ABLACIJA_CKPT, "ablation_no_edgebranch_sepia25ep.pth")
...
CKPT_FINAL = os.path.join(DIR_ABLACIJA_CKPT, "ablation_no_edgebranch_final.pth")
...
csv_out = os.path.join(DRIVE_PROJECT_DIR, "rezultat_ablacija_9_no_edgebranch.csv")
