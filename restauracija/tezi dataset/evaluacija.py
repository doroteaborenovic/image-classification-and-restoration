...
output_dir = '/content/drive/MyDrive/Projekat_Model/EVALUACIJA_REZULTATI_TEZI'
local_extract_path = '/content/test_tezi'
...
def pokreni_evaluaciju():
    ...
    csv_report_path = os.path.join(output_dir, 'izvestaj_metrika_test_tezi.csv')
    statistika.to_csv(csv_report_path, index=False)

    print(f"\n{'='*110}")
    print(" EVALUACIJA (TEŽI SKUP) ZAVRŠENA")
    print(f"{'='*110}")
